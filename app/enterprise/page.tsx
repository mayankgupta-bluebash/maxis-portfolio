  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <stop offset="1" stopColor="#C1B0F1" />
      </linearGradient>
    </defs>
  </svg>
);
  ...
  >
    ...
    <defs>
      ...
      >
        ...
        <stop offset="0.53" stopColor="#9573DE" />
...
const EnterprisePage: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "SOC2 Type 2 & GDPR compliant with SCIM/SAML integration and advanced role-based access—ensuring Fortune 500-level data protection.",
    },
    {
      icon: <HandshakeIcon />,
      title: "Premium Partnership",
      description:
        "Always-on support with account managers and exclusive founder-led guidance.",
    },
    {
      icon: <BulbIcon />,
      title: "Advanced AI Capabilities",
      description:
        "Fine-tuned LLMs, deep insights, and limitless agentic workflows, built for complexity at scale.",
    },
    {
      icon: <MonitoringIcon />,
      title: "Unlimited Scalability",
      description:
        "Dedicated cloud with unlimited integrations, agentic app scalability, and 99.9% uptime.",
    },
  ];
  ...
  const capabilities = [
    {
      title: "Enterprise Security",
      description:
        "SOC2 Type 2, GDPR compliance, SCIM/SAML support, and custom data retention",
    },
    {
      title: "Unlimited Scale",
      description:
        "Custom ACU credits, unlimited agents, unlimited users, and dedicated infrastructure",
    },
    {
      title: "Advanced Features",
      description:
        "Fine-tuned LLM support, advanced analytics, and custom integrations",
    },
    {
      title: "Premium Support",
      description:
        "24/7 on-call support, dedicated expert, and private workshops with founders",
    },
  ];
  ...
  return (
    <Box sx={{ background: "#080411", minHeight: "100vh", pt: "72px" }}>
      ...
      <Container maxWidth="xl" sx={{ py: { xs: 8, md: 10 } }}>
        ...
        >
          ...
          >
            ...
            >
              Purpose-built for large organizations requiring enterprise-grade
              security, compliance, and scalability in their AI automation
              initiatives.
            </Typography>
      ...
      <Container maxWidth="xl" sx={{ py: 8 }}>
        <Box sx={{ maxWidth: "1280px", mx: "auto" }}>
          <Box sx={{ textAlign: "center", mb: 8 }}>
            ...
            >
              Deploy agents across your research pipeline to reduce review time,
              extract deep scientific insights, and drive actionable outcomes in
              days—not months.
            </Typography>
          </Box>
      ...
      <Container maxWidth="xl" sx={{ py: 8 }}>
        <CTASection sx={{ maxWidth: "1280px", mx: "auto", p: 6 }}>
          ...
          >
            ...
            >
              Let's bring intelligent automation to your team, without the
              complexity.
            </Typography>
            <Button
              variant="contained"
      ...
      <FAQSection>
        ...
        >
          <GradientText variant="h2" sx={{ fontSize: "56px", fontWeight: 500 }}>
            Frequently
            <br />
            Asked Questions
          </GradientText>
