...
const renderFeatureValue = (value: any) => {
  ...
  return (
    <Typography
      sx={{ color: "#999", fontSize: "13.26px", textAlign: "center" }}
    >
      {value}
    </Typography>
  );
    ...
    <StyledModal open={open} onClose={onClose}>
      <ModalContent>
        ...
        <Header>
          ...
          >
            <IconButton onClick={onBack} sx={{ color: "#FFF", p: 0 }}>
              <ArrowBackIcon />
            </IconButton>
            <Typography
              sx={{
        ...
        >
            ...
            {plans.map((plan, index) => (
              <PlanCard key={plan.name} featured={plan.featured}>
                {plan.featured && (
                  ...
                  >
                    <Typography sx={{ color: "#F9FAFC", fontSize: "14px" }}>
                      Most Popular
                    </Typography>
                  </Box>
                )}
                        ...
                        : {
                            borderColor:
                              plan.name === "Individual"
                                ? "rgba(111, 65, 210, 0.50)"
                                : "#7352D5",
                            backgroundColor:
                              plan.name === "Individual"
                                ? "rgba(111, 65, 210, 0.10)"
                                : "transparent",
                            color: "#8F75DD",
                            "&:hover": {
          ...
          >
            ...
            <FeatureTable component={Paper} elevation={0}>
              <Table>
                <TableHead>
                  <TableRow>
                    <HeaderCell sx={{ width: "425.16px", textAlign: "left" }}>
                      Features
                    </HeaderCell>
                          ...
                          {feature.values.map((value, valueIndex) => (
                            <React.Fragment key={valueIndex}>
                              {valueIndex === 2 ? (
                                ...
                                <FeatureCell sx={{ textAlign: "center" }}>
                                  {renderFeatureValue(value)}
                                </FeatureCell>
                              )}
                            </React.Fragment>
