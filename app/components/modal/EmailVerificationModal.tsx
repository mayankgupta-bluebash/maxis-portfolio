...
export default function EmailVerificationModal({
  ...
  return (
    ...
    >
      <Box
        sx={{
          width: { xs: "90vw", md: "1220px" },
          height: { xs: "auto", md: "912px" },
          bgcolor: "#080411",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Image src={logoPng} alt="Logo" width={110} height={30} />
            </Box>
            ...
            <Box
              sx={{
                ...
                boxShadow:
                  "0px 10px 15px -3px rgba(0, 41, 41, 0.08), 0px 4px 6px -4px rgba(0, 41, 41, 0.08)",
              }}
            >
              {/* Text Content */}
              <Box
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Box component="span" sx={{ color: "#8F75DD" }}>
                      {email}
                    </Box>
                  </Typography>
                </Box>
              ...
              >
                ...
                <Box
                  ...
                  sx={{
                    ...
                    pointerEvents: otp.every((digit) => digit !== "")
                      ? "auto"
                      : "none",
                  }}
                >
