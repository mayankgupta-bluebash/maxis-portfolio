...
const StakeholderImage = styled("img")({
  width: "70px",
  height: "60px",
  borderRadius: "32px 31px 19px 21px",
});
...
const VisionMissionCard = styled(Card)({
  ...
  background: "rgba(37, 26, 73, 0.50)",
  boxShadow:
    "0px 10px 15px -3px rgba(0, 41, 41, 0.04), 0px 4px 6px -4px rgba(0, 41, 41, 0.04)",
  display: "flex",
  flexDirection: "column",
  gap: "24px",
  maxWidth: "1280px",
      ...
      <Container maxWidth="xl" sx={{ py: 10 }}>
        ...
        >
          ...
          >
            ...
            >
              MaxisIT empowers life sciences to reduce risk, time, and cost with
              integrated data management and analytics solutions.
            </Typography>
          ...
          >
            ...
            <Box
              sx={{
                ...
                opacity: 0.75,
                background:
                  "linear-gradient(180deg, #601EF9 0%, rgba(96, 30, 249, 0.00) 100%)",
                filter: "blur(100px)",
              }}
            />
            ...
            {/* Stakeholder Cards */}
            <StakeholderCard position={{ top: "383px", left: "0px" }}>
              <StakeholderImage
            ...
            <StakeholderCard position={{ top: "62px", left: "232px" }}>
              <StakeholderImage
            ...
            >
              ...
              >
                <svg width="27" height="27" viewBox="0 0 27 27" fill="none">
                  <path d="M13.5 13.5L21 8V19L13.5 13.5Z" fill="#6824B3" />
                </svg>
              </div>
              <StakeholderLabel>
                Healthcare
            ...
            <StakeholderCard position={{ top: "544px", left: "228px" }}>
              <div
                style={{
                  width: "70px",
                  height: "63px",
      ...
      <Container maxWidth="xl" sx={{ py: 8 }}>
        ...
        >
          ...
          >
            ...
            >
              We're not just building AI—we're transforming how medical research
              happens.
              <br />
              At Maxis, we combine deep domain expertise with agentic automation
              to accelerate discovery and bring innovations to life faster.
            </Typography>
      ...
      <Container maxWidth="xl" sx={{ py: 8 }}>
        <Box sx={{ maxWidth: "1280px", mx: "auto" }}>
          <Box sx={{ textAlign: "center", mb: 6 }}>
            ...
            >
              Whether you're here to build intelligent agents or to use AI tools
              without coding, our platform is built for both.
            </Typography>
                ...
                <Box>
                  <Typography
                    ...
                    sx={{
                      ...
                      lineHeight: "41.6px",
                      background:
                        "linear-gradient(143deg, #8E76FF 5.43%, #C1B0F1 94.57%)",
                      WebkitBackgroundClip: "text",
                      backgroundClip: "text",
                      color: "transparent",
                      mb: 3,
                  ...
                  >
                    To deliver premier products that increase clinical trial
                    success rates and reduce trial costs by automatically
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <VisionMissionCard>
                ...
                <Box>
                  ...
                  >
                    To help our customers deliver the right products to the
                    right patients, on time
                  </Typography>
                </Box>
              </VisionMissionCard>
            </Grid>
      ...
      <Container maxWidth="xl" sx={{ py: 8 }}>
        ...
        >
          ...
          >
            ...
            >
              Have questions? Looking to scale your R&D with AI agents? Our
